# Primeiro Exemplo: Funcão já recebe o arquivo como parâmetro
import json
...
# Segundo Exemplo: Função espera o nome de um arquivo e a abertura do mesmo acontece dentro da função
# import json
