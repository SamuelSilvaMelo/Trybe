# Trybe Exercises
This repository have all the exercises developed by [Samuel Silva Melo](https://www.linkedin.com/in/samuel-silva-melo/) 
during Trybe's course. 

I give all the credit for this README file, to [Eric Massaki Hirayama](https://www.linkedin.com/in/erichirayama/), beeing him the one who made it. Big thanks for you, my Trybe colleague, for letting me use your incredible README! =)
...
```git
git clone git@github.com:moraes-webdev/Trybe-Exercises.git
```
